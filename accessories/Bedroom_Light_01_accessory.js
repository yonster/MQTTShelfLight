var name = "Bedroom Light 01";
var lightIDString = "01"
var serialNumber = "LGHT0001";
var userName = "1A:2B:3C:4D:3E:FD";
...
client.on('message', function (topic, message) {
  ...
  if (message != "") {
    ...
    if (status[0] == lightIDString) {
      ...
      // }
      BEDROOM_LIGHT.powerOn = (status[1] == "ON");
      BEDROOM_LIGHT.hue = parseFloat(status[2]);
      BEDROOM_LIGHT.saturation = parseFloat(status[3]);
      BEDROOM_LIGHT.brightness = parseFloat(status[4]);
    }
  }
});
